...
class LuaAPI extends Component {
	...
	componentDidMount(){
		...
		$.when(
			...
			$.get("./Luadoc++/FunctionDefs.json", funcdefs  => lua_api.docs.github.funcdefs = funcdefs )

		).then(function(){

			// We have two xml files to retrieve data from, lua_documentation and lua_dot_xml
			//
			// Many classes and functions have manually-documented descriptions in LuaDocumentation.xml,
			// but not all.  Lua.xml, on the other hand, is a list of classes and functions, autogenerated
			// using the command-line argument "--ExportLuaInformation" when starting StepMania.
			//
